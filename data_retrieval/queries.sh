...
<<comment
curl -X GET 'http://localhost:8983/solr/articles/query?group=true%3Dtrue&group.field=abbreviation&group.limit=10&parent.q={!parent%20which="*:*%20-_nest_path_:*"%20v=\{!terms%20f=id%20v=$row.article_id\}}&fl=*,parent:\[subquery\]' -d '
{
    "query": "_nest_path_:\\/named_teams AND ({!child of=\"*:* -_nest_path_:*\"}title:comeback OR summary:comeback OR text:comeback)"
}'
